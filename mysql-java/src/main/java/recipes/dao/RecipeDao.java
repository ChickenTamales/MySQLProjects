...
//@formatter: off
		...
		+ "WHERE recipe_id = ?" + " ORDER BY c.category_name";
...
//@formatter: off
		...
		String sql = ""
				/*
				 * will select unit name from ingredient table whether or not a unit exists 
				 * will order by ingredient order
				 */
				+ "SELECT i.*, u.unit_name_singular, u.unit_name_plural " + "FROM " 
				+ INGREDIENT_TABLE + " i "
